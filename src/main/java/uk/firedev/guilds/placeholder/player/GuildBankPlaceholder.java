...
public class GuildBankPlaceholder implements IPlaceholder {

    @Override
    public boolean shouldProcess(@NonNull String identifier) {
        return identifier.equals("guild_bank");
    }
    ...
    public @Nullable String parse(@Nullable OfflinePlayer player, @NonNull String identifier) {
        ...
        return guild == null ? "No Guild" : String.valueOf(guild.getBalance());
    }
