...
public class GuildOnlineMembersPlaceholder implements IPlaceholder {

    @Override
    public boolean shouldProcess(@NonNull String identifier) {
        return identifier.equals("guild_online_members");
    }
    ...
    public @Nullable String parse(@Nullable OfflinePlayer player, @NonNull String identifier) {
        ...
        return guild == null ? "No Guild" : String.valueOf(guild.getOnlineMembers().size());
    }
