...
import uk.firedev.chatchannels.libs.daisylib.messages.message.ComponentSingleMessage;
...
public class MessageConfig extends BasicConfig {
    ...
    public ComponentSingleMessage getPrefix() {
        return super.getComponentMessage("prefix", "<gray>[Guilds]</gray> ").toSingleMessage();
    }
